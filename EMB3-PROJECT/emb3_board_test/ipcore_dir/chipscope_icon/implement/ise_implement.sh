...
ngdbuild -uc ../../example_design/example_chipscope_icon.ucf -p xc6slx45-fgg484-3 -sd . example_chipscope_icon.ngc example_chipscope_icon.ngd
if [ $? -gt 0 ] ; then 
...
##-------------------------------Run map-------------------------------------------
echo 'Running map'
map -w -p xc6slx45-fgg484-3 -o example_chipscope_icon.map.ncd example_chipscope_icon.ngd
if [ $? -gt 0 ] ; then 
